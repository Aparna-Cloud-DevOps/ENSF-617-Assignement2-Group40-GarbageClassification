...
from model_lstm import ResNetLSTMModel
...
# ============================================================
# MODEL INITIALIZATION (ResNet18 + LSTM)
# ============================================================
vocab_size = len(train_dataset.vocab)
num_classes = len(train_dataset.classes)

# Instantiate multimodal model
model = ResNetLSTMModel(vocab_size, num_classes).to(device)
...
for epoch in range(epochs):
    ...
    ckpt_path = f"checkpoints/resnet_lstm_epoch_{epoch+1}.pth"
...
}, "resnet_lstm_model_final.pth")

print("Training completed and model saved as resnet_lstm_model_final.pth")