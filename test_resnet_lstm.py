...
# PATHS
# ============================================================
# Training dataset → used only to load vocab/classes
# Test dataset → used for evaluation
# model_path → trained ResNet+LSTM checkpoint
...
model_path = "resnet_lstm_model_final.pth"
...
# ============================================================
# MODEL DEFINITION (ResNet18 + LSTM)
# ============================================================
class ResNetLSTMModel(nn.Module):
    ...
    def forward(self, image, text):
        ...
        text_feat = hidden[-1]  # final hidden state (128‑dim)
...
model = ResNetLSTMModel(len(vocab), len(classes))
...
print("ResNet+LSTM Model loaded successfully.")
...
# Print results
print(f"ResNet+LSTM Model Accuracy: {accuracy:.2f}%")
